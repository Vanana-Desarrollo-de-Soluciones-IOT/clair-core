...
public class DeviceMonthlySummary {
    ...
    private final LocalDate summaryMonth;
    ...
    public DeviceMonthlySummary(
        ...
        this(UUID.randomUUID(), deviceId, summaryMonth, co2, pm2_5, temperature, humidity, peakPm2_5,
                peakPm2_5At, averageAqi, dominantAqiCategory, categoryBreakdown, readingCount,
                daysCovered, aqiDeltaPct, null, null);
    }

    /** Rebuilds a summary already in storage; only a persistence assembler should call this. */
    public static DeviceMonthlySummary reconstitute(
            UUID id,
            DeviceId deviceId,
            LocalDate summaryMonth,
            MetricStats co2,
